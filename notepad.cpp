...
int user::verify_password(char s[])
{
	int i;
...
void fun(user user1)
{
	clear;
	char c;
	cout << "In programming, function refers to a segment that groups code to perform specific task.\n Depending on whether a function is predefined or created by programmed; there are two types of function:\n 1.Library FUnction\n 2.User-defined function\n \n Librar Function:\n Library functions are built-in functions in C++ programmig. \nProgrammer can user library function byinoking fuction directly; they dont write it themselves.\n\n";
...
void fun71(user user1)
{
	clear;
	char c;
	cout << "textcolor() This function is used to change the text color.";
	cout << "do you want to take notes";
	cin >> c;
	if (c == 'y')
		user1.takenotes("textcolor: \n");
	user1.incre();
}
